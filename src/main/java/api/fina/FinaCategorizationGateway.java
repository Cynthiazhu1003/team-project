...
/**
 * Interface for the service of auto categorization a list of lists of strings in the format [["name", "merchant", "amount"]]
 */
public interface FinaCategorizationGateway {
     ...
     * @return the same list of rows but with the category generated from the api attached to each row separately
