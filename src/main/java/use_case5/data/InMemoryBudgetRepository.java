...
/**
 * In memory budget DAO for storing user budgets.
 */
public class InMemoryBudgetRepository implements BudgetRepository {
    ...
    public void delete(String category) {
        if (storage.containsKey(category)) {
            ...
            System.out.println("[DAO] Deleted budget for '" + category + "'");
        } else {
            System.out.println("[DAO] Cannot delete, no budget found for '" + category + "'");
        }
    }
